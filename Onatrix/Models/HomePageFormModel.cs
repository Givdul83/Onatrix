...
namespace Onatrix.Models
{
    public class HomePageFormModel
    {
        ...
        [RegularExpression(@"^[a-zA-Z]{2,}$", ErrorMessage = "Invalid name, it must contain at least two characters")]
        ...
        [RegularExpression(@"^\d{7,14}$", ErrorMessage = "Invalid phone number")]
